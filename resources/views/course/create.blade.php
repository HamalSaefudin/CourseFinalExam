            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="course_name" id="course_name" class="form-control @error('course_name') is-invalid @enderror" value="{{ old('course_name') }}">
                            @error('course_name')
                ...
                <div class="row">
                    <div class="form-group ms-4 d-flex align-items-baseline">
                        <input class="form-check-input mb-2" type="checkbox" name="is_certificate" id="is_certificate" value="Y">
                        <label class="form-check-label mb-0" style="margin-left: 10px;margin-top:2px" for="is_certificate">Ber sertifikat</label>
                    </div>
                    <div class="form-group ms-4 d-flex align-items-baseline">
                        <input class="form-check-input mb-2" type="checkbox" name="is_active" id="is_active" value="Y">
